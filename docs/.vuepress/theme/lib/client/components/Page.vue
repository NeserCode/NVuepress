...
.original-info {
	@apply relative flex justify-center items-center h-24 sm:h-full my-6 p-4 pr-0 sm:pr-4 rounded shadow border-2
...
.original-info .cc-text {
	@apply inline-flex flex-col justify-center items-center px-4;
}
